...
export async function onboard(opts: OnboardOptions): Promise<void> {
  ...
  if (existingConfig) {
    p.log.message(
      pc.dim("Existing Nova Corps install detected; keeping the current configuration unchanged."),
    );
    ...
    p.outro("Existing Nova Corps setup is ready.");
    return;
  }
