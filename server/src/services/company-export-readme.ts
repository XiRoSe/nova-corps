...
export function generateReadme(
  ...
  lines.push("");
  lines.push("> This is an [Agent Company](https://agentcompanies.io) package from [Nova Corps](https://paperclip.ing)");
  lines.push("");
  ...
  lines.push("```");
  lines.push("");
  lines.push("See [Nova Corps](https://paperclip.ing) for more information.");
  lines.push("");

  // Footer
  lines.push("---");
  lines.push(`Exported from [Nova Corps](https://paperclip.ing) on ${new Date().toISOString().split("T")[0]}`);
  lines.push("");
